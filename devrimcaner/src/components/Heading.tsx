      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={4}>
          <Box className="box">
            ...
            <img src="https://placehold.co/600x400/3d3d3d/png" style={{maxWidth:'100%'}} alt="placeholder" />
        ...
        <Grid item xs={12} md={4}>
          <Box className="box">
            ...
            <img src="https://placehold.co/600x400/4b6584/png" style={{maxWidth:'100%'}} alt="placeholder" />
          </Box>
        </Grid>
        <Grid item xs={12} md={4}>
          <Box className="box">
            ...
            <img src="https://placehold.co/600x400/2d3436/png" style={{maxWidth:'100%'}} alt="placeholder" />
